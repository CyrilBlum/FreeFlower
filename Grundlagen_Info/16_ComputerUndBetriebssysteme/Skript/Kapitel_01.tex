...
\begin{myexercise}\label{myexercise:overflow}
	...
	\begin{myanswer}
		Die mathematisch richtige Antwort wäre eigentlich $100000000_2$. Falls wir die Rechnung jedoch in einer 8-Bit-Umgebung ausführen (wie es die ersten Computer waren), könnte das Resultat auch 0 sein, da die Zahl zu lang würde (\tib{Überlauf}\index{Überlauf}, en. \textit{overflow}).
	\end{myanswer}
\end{myexercise}
...
Nachdem wir nun wissen, wie sich Zahlen im Binärsystem darstellen und berechnen lassen, stellt sich die nächste Frage: Wie kodiert man damit auch Buchstaben, Bilder und andere Informationen? Diesem Thema widmet sich \cref{ch:kodierungen}.
