...
\begin{frame}{Auftrag}{Kapitel 4: NAND \& Halbaddierer}
...
\aufgabebox{\textbf{Aufgabe 4.4}: Tabellen zur Funktionsweise des Halbaddierers und binären Addition ausfüllen}
\end{frame}
