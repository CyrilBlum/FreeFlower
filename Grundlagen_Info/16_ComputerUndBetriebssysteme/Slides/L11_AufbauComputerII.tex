...
\auftragframe{Kapitel 5, Abschnitte \enquote{Arbeitsspeicher (RAM)} bis \enquote{Der Fetch-Decode-Execute-Zyklus}}{%
\aufgabebox{Teilschritte des Additionsbefehls den drei Phasen zuordnen}
}
