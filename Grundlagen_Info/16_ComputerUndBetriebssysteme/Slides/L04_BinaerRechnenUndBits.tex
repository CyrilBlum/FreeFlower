...
\auftragframe{Kapitel 2, Abschnitt \enquote{Rechnen im Binärsystem}}{%
\aufgabebox{Schriftliche Addition im Binär- und Hexadezimalsystem}\\[3mm]
\challengebox{Was ist die grösste $n$-stellige Binärzahl?}
}
...
\auftragframe{Kapitel 3, Abschnitt \enquote{Bits und Bytes}}{%
\aufgabebox{Wie viele unterschiedliche Zeichen lassen sich mit $n$ Bits darstellen?}
}
