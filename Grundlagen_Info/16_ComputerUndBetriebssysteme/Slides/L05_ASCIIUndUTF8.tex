...
\auftragframe{Kapitel 3, Abschnitt \enquote{Kodierung von Buchstaben: ASCII-Tabellen und UTF-8}}{%
\aufgabebox{Übungen zu ASCII und UTF-8}\\[3mm]
\aufgabebox{Schreiben Sie Ihren Namen in ASCII-Kodierung}
}
