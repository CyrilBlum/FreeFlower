...
\auftragframe{Kapitel 2, Abschnitte \enquote{Ursprünge der Zahlendarstellung} und \enquote{Basisgrössen}}{%
\aufgabebox{Erweitern Sie das römische Münzsystem (siehe Skript-Übung)}
}
...
\auftragframe{Kapitel 2, Abschnitt \enquote{Stellenwertdarstellung}}{%
\aufgabebox{Übungen zur Umrechnung Binär $\leftrightarrow$ Dezimal}\\[3mm]
\challengebox{Begründen Sie, warum Basis $b=1$ nicht sinnvoll ist}
}
