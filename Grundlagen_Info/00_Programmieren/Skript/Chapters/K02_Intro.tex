...
Ein \textbf{Programm} ist im Grunde eine Reihe von Befehlen in einer Programmiersprache, die zusammen eine bestimmte Aufgabe lösen. Stellen Sie sich ein Programm als eine genaue Anleitung vor, die ein Computer Schritt für Schritt abarbeiten kann.
