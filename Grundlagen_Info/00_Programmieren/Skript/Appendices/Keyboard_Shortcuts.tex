...
\begin{multicols}{2}
	\begin{threeparttable}[H]
		...
		\begin{tabular}{p{3.9cm}||c|c}
			...
			\makecell[l]{\faCaretLeft{} Fenster links anordnen                                                                                                                                                                    \\\faCaretRight{} Fenster rechts anordnen} &\makecell[l]{\keys{\faWindows+\arrowkeyleft}\\ \keys{\faWindows+\arrowkeyright}}& \makecell{\keys{\ctrl+\Alt+\arrowkeyleft}\\\keys{\ctrl+\Alt+\arrowkeyright}}\tnote{c} \\
		\end{tabular}
		\begin{tablenotes}
			...
			\item[c] Setzt \href{https://rectangleapp.com/}{Rectangle}-App auf MacOS voraus
		\end{tablenotes}
