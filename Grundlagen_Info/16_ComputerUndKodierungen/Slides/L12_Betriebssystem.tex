...
\begin{frame}\FDUtitle{Übung: Software-Stack}
\aufgabebox{\textbf{Aufgabe 6.2 (Zuordnung zum Software-Stack)}}
\end{frame}
...
\begin{frame}\FDUtitle{Übung: Multitasking}
\aufgabebox{\textbf{Aufgabe 6.1 (Multitasking \& Zeitscheiben)}}
\end{frame}
...
\vspace{3mm}
\aufgabebox{\textbf{Aufgabe 6.1}}
\vspace{2mm}
\aufgabebox{\textbf{Aufgabe 6.2}}
\vspace{2mm}
\challengebox{\textbf{Aufgabe 6.3}}
\end{frame}
