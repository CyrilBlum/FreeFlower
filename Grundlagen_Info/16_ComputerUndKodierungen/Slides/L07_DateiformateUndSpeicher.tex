...
\begin{table}[H]
	...
	\begin{tabular}{@{}l|rr|l@{}}
		...
		ZB (Zettabyte)       & $10^{21}$ B                                 & ...                 & alle Daten ($\sim$ 100 ZB) \\ \midrule
	\end{tabular}
\end{table}
\end{frame}
...
\aufgabebox{\textbf{Aufgabe 3.17}: Video anschauen (Passwort: BinCode)}
\vspace{3mm}
\aufgabebox{\textbf{Aufgabe 3.18}: Üblicher/gebräuchlicher Name für ein \enquote{Megagramm}}
\vspace{3mm}
\challengebox{\textbf{Aufgabe 3.19}: Warum Festplatten unter Windows kleiner wirken}
\end{frame}

\begin{frame}\FDUtitle{Lösung: Aufgabe 3.18}
\begin{table}[H]
	\footnotesize
	\centering
	\begin{tabular}{@{}l|rr|l@{}}
...
\begin{frame}\FDUtitle{Lösung: Aufgabe 3.19}
\begin{center}
