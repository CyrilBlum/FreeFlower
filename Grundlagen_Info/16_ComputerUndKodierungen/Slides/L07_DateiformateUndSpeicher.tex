...
\aufgabebox{\textbf{Aufgabe 3.15}: Video anschauen (Passwort: BinCode)}
\vspace{3mm}
\aufgabebox{\textbf{Aufgabe 3.16}: Üblicher/gebräuchlicher Name für ein \enquote{Megagramm}}
\vspace{3mm}
\challengebox{\textbf{Aufgabe 3.17}: Warum Festplatten unter Windows kleiner wirken (Apple-Artikel lesen)}
\end{frame}
