...
\begin{frame}\lessontitle{Lektion 11}{Aufbau eines Computers II}{Arbeitsspeicher (\glsentryshort{RAM}), Massenspeicher \& Schnittstellen \textperiodcentered{} Skript, Kapitel 5}\end{frame}
...
\begin{frame}\FDUtitle{Aufgabe: Ein Game von Steam herunterladen}
...
\begin{frame}\FDUtitle{Übung: Welche Komponente braucht welche Schnittstelle?}
Ordnen Sie den Datenbedarf der passenden Schnittstelle zu:
\begin{enumerate}[<+->][(a)]\small\setlength\itemsep{3pt}
  \item \textbf{Gaming-Grafikkarte ($\approx 30\,\mathrm{GB/s}$):} $\mathbf{\text{PCIe 4.0 }\times 16}$ ($32\,\mathrm{GB/s}$ für 3D-Rendering)
  \item \textbf{Interne M.2-NVMe-SSD ($\approx 7\,\mathrm{GB/s}$):} $\mathbf{\text{PCIe 4.0 }\times 4}$ ($8\,\mathrm{GB/s}$, volle Flash-Power)
  \item \textbf{Externe GPU am Laptop ($\approx 5\,\mathrm{GB/s}$):} $\mathbf{\text{Thunderbolt 3/4}}$ ($5\,\mathrm{GB/s} = 40\,\mathrm{Gbit/s}$)
  \item \textbf{Mobile Video-SSD ($\approx 1{,}5\,\mathrm{GB/s}$):} $\mathbf{\text{USB-C}}$ (USB 3.2 Gen 2, $1{,}25\text{--}2{,}5\,\mathrm{GB/s}$)
  \item \textbf{Interne 3.5"-Archiv-HDD ($\approx 0{,}15\,\mathrm{GB/s}$):} $\mathbf{\text{SATA-Kabel}}$ ($0{,}55\,\mathrm{GB/s}$ bremst nicht)
  \item \textbf{Maus \& Tastatur ($\approx 0{,}001\,\mathrm{GB/s}$):} $\mathbf{\text{USB-A}}$ (Standard für einfache Steuersignale)
\end{enumerate}
\end{frame}
