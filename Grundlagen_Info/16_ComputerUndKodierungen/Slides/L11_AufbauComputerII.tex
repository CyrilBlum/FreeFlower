...
\aufgabebox{\textbf{Aufgabe 5.2}: Dauer berechnen: Foto ($24\,\mathrm{MB}$) von SSD ($2\,\mathrm{GB/s}$) laden}
\vspace{3mm}
\aufgabebox{\textbf{Aufgabe 5.3}: Speicherzeit für ein Steam-Game (120~GB) in RAM, auf SSD und auf HDD vergleichen}
\vspace{3mm}
\aufgabebox{\textbf{Aufgabe 5.4}: Befehle/s und Ausführungsdauer bei $3{,}6\,\mathrm{GHz}$ berechnen}
\vspace{3mm}
\challengebox{\textbf{Aufgabe 5.5}: Teilschritte des Befehls \texttt{ADD R1, R2} den Phasen Fetch, Decode, Execute zuordnen}
\end{frame}
