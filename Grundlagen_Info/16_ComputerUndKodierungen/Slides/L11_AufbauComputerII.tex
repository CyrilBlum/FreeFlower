...
\vspace{3mm}
\aufgabebox{\textbf{Aufgabe 5.3}: Befehle/s und Ausführungsdauer bei $3{,}6\,\mathrm{GHz}$ berechnen}
\vspace{3mm}
\challengebox{\textbf{Aufgabe 5.4}: Teilschritte des Befehls \texttt{ADD R1, R2} den Phasen Fetch, Decode, Execute zuordnen}
\end{frame}
