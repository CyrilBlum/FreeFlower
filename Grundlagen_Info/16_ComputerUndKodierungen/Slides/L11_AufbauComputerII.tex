...
\vspace{3mm}
\aufgabebox{\textbf{Aufgabe 5.3}: Speicherzeit für ein Steam-Game (120~GB) in RAM, auf SSD und HDD}
\vspace{3mm}
\aufgabebox{\textbf{Aufgabe 5.4}: Befehle/s und Ausführungsdauer bei $3{,}6\,\mathrm{GHz}$ berechnen}
\vspace{3mm}
\challengebox{\textbf{Aufgabe 5.5}: Teilschritte von \texttt{ADD R1, R2} zu Fetch, Decode, Execute zuordnen}
\end{frame}
