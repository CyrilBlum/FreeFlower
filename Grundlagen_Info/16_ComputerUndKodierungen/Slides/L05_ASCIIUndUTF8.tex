...
\renewcommand{\thelektion}{L06 \textperiodcentered{} ASCII \& UTF-8}

\begin{frame}\lessontitle{Lektion 06}{Kodierung von Buchstaben}{ASCII und UTF-8 \textperiodcentered{} Skript, Kapitel 2}\end{frame}
...
\aufgabebox{\textbf{Aufgabe 3.3}: Wie viele Zeichen lassen sich mit 7-Bit ASCII abbilden?}
\vspace{3mm}
\aufgabebox{\textbf{Aufgabe 3.4}: Grösste binäre Zahl mit 8 Bits und in Hexadezimal}
\vspace{3mm}
