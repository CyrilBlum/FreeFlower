...
\begin{myexercise}\label{myexercise:volladdierer-formel}
    ...
    Betrachten Sie die Wahrheitstabelle des Volladdierers (\cref{tab:volladdierer_wahrheitstabelle}) mit den Eingängen $x, y, c_{\text{in}}$ und den Ausgängen $s$ (Summe) und $c_{\text{out}}$ (Übertrag).
    \begin{enumerate}[(a)]
