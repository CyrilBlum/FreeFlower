...
\begin{figure}[H]
    \centering
    \input{Grundlagen_Info/16_ComputerUndKodierungen/Figures/tikz_informatik_timeline.tex}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.48\textwidth}
        \centering
        \includegraphics[width=\linewidth,height=48mm,keepaspectratio]{Grundlagen_Info/16_ComputerUndKodierungen/Slides/assets/people/babbage_difference_engine.jpg}
        \caption{Babbages \textit{Difference Engine No. 2} (Nachbau, London).}
    \end{subfigure}\hfill
    \begin{subfigure}{.48\textwidth}
        \centering
        \includegraphics[width=\linewidth,height=48mm,keepaspectratio]{Grundlagen_Info/16_ComputerUndKodierungen/Slides/assets/people/z3.jpg}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.48\textwidth}
        \centering
        \includegraphics[width=.75\linewidth,height=44mm,keepaspectratio]{Grundlagen_Info/16_ComputerUndKodierungen/Slides/assets/people/lovelace.jpg}
        \caption{Ada Lovelace (1815--1852)}
    \end{subfigure}\hfill
    \begin{subfigure}{.48\textwidth}
        \centering
        \includegraphics[width=.75\linewidth,height=44mm,keepaspectratio]{Grundlagen_Info/16_ComputerUndKodierungen/Slides/assets/people/turing.jpg}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.48\textwidth}
        \centering
        \includegraphics[width=\linewidth,height=46mm,keepaspectratio]{Grundlagen_Info/16_ComputerUndKodierungen/Slides/assets/people/enigma.jpg}
        \caption{Deutsche Enigma-Chiffriermaschine.}
    \end{subfigure}\hfill
    \begin{subfigure}{.48\textwidth}
        \centering
        \includegraphics[width=\linewidth,height=46mm,keepaspectratio]{Grundlagen_Info/16_ComputerUndKodierungen/Slides/assets/people/first_bug.jpg}
