\begin{tikzpicture}[
    ...
    \draw[thick, ->, ForestGreen] (fa2.west) -- ++(-1.2, 0) node[left, font=\small, ForestGreen] {$s_3 = \textbf{?}$};
    ...
    \node[font=\small, align=center] at (3.6, -2.7) {Gesamtergebnis: $(\textcolor{ForestGreen}{s_3 \, s_2 \, s_1 \, s_0})_2 = \textcolor{ForestGreen}{\textbf{?}_2} = \textcolor{ForestGreen}{\textbf{?}_{10}}$};
\end{tikzpicture}
