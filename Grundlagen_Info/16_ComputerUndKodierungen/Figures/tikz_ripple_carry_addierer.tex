\begin{tikzpicture}[
    ...
    \draw[wire, BurntOrange] (fa2.west) -- ++(-1.2, 0) node[left, font=\small, BurntOrange] {$c_3$};
    ...
    % Summary label
    \node[font=\small\bfseries, align=center] at (3.6, -2.7) {$s_3=c_3$;\quad Ergebnis: $(\textcolor{ForestGreen}{s_3 \, s_2 \, s_1 \, s_0})_2$};
\end{tikzpicture}
