\begin{tikzpicture}[
    ...
    \draw[thick, ->, ForestGreen] (fa2.west) -- ++(-1.2, 0) node[left, font=\small, color=ForestGreen] {$s_3 = \mathbf{0}$};
    ...
    % Result line
    \node[font=\small\bfseries, align=center, color=ForestGreen] at (3.6, -2.7) {Gesamtergebnis: $(\textcolor{ForestGreen}{s_3 \, s_2 \, s_1 \, s_0})_2 = \mathbf{0101_2} = \mathbf{5_{10}}$ \quad ($3 + 2 = 5$ \checkmark)};
\end{tikzpicture}
