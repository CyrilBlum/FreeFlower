...
\begin{todolist}
  ...
  \item Ich kann die Bedrohung klassischer asymmetrischer Verfahren (RSA, DHM) durch Quantencomputer (Shor-Algorithmus) erklären und das Grundprinzip der Post-Quanten-Kryptographie (z.\,B.\ gitterbasierte Verfahren wie LWE) beschreiben.
\end{todolist}
