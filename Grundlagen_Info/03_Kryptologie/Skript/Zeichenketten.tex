...
\lstinline|text1.count(text2)| & Zählt, wie oft der Text \lstinline|text2| im Text \lstinline|text1| vorkommt & \begin{minipage}{\linewidth}
\begin{lstlisting}[numbers=none]
text = "Das Haus ist gross und das Dach ist grün."
n = text.count("ist") # 2
\end{lstlisting}
\end{minipage}\\\midrule
\lstinline|text1.find(text2)| & Gibt den niedrigsten Index des Teiltexts \lstinline|text2| zurück, falls dieser vorhanden ist, ansonsten \lstinline|-1| & \begin{minipage}{\linewidth}
\begin{lstlisting}[numbers=none]
text = "Das Haus ist gross und das Dach ist grün."
text.find("ist") # 9
\end{lstlisting}
\end{minipage}\\\midrule
\lstinline|text.replace(old, new)| & Ersetzt alle Vorkommen des Teil-Texts \lstinline|old| durch \lstinline|new|. & \begin{minipage}{\linewidth}
\begin{lstlisting}[numbers=none]
text = "hallo"
...
\lstinputlisting{Grundlagen_Info/03_Kryptologie/Python package/encryption/umkehren.py}
 ...
 \lstinline|text.split(sep)| & Zerlegt den Text an jedem \texttt{sep} und gibt eine Liste der Teiltexte zurück.  & \begin{minipage}{\linewidth}
 \begin{lstlisting}[numbers=none]
text = "a,b,c"
...
\end{lstlisting}
 \end{minipage}\\\midrule
  \lstinline|sep.join(liste)| & Verbindet die Elemente von \texttt{liste} zu einem Text, getrennt durch den Text \texttt{sep}.  & \begin{minipage}{\linewidth}
  \begin{lstlisting}[numbers=none]
txt = ":".join(["a", "b", "c"]) 
# "a:b:c"
\end{lstlisting}
