...
% Aufrechte griechische Symbole für physikalische Einheiten.
\usepackage{upgreek}
...
\input{FF/Robotik/Skript/Chapters/chapter_02.tex}
% C++-Listings und Einheitendarstellung auf das Sensorenkapitel begrenzen.
\begingroup
\lstset{language=C++,columns=fullflexible,basicstyle=\ttfamily\footnotesize}
\input{FF/Robotik/Skript/Chapters/chapter_03.tex}
\endgroup
...
\appendix
\input{FF/Robotik/Skript/Chapters/appendix.tex}
