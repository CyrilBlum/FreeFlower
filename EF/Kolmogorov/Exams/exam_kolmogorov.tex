...
\end{solution}
	...
	\textbf{Bemerkung:} Die Ausdrücke \verb|n| und \verb|n**2| zwischen den Escape-Sequenzen stehen für die konkreten Binärdarstellungen von $n$ beziehungsweise $n^2$. Beachte bei der Beurteilung von \cref{listing:Cn}, dass ein gültiges \texttt{C'++}-Programm zwar denselben binären Block mehrfach, aber nicht zwei verschiedene binäre Blöcke enthalten darf.
...
\end{lstlisting}
	\begin{solution}
		Die Programme $A_n$ und $B_n$ sind gültig und generieren jeweils $w_n$. In $B_n$ bezeichnen alle drei Vorkommen von \cppinline{***n+++} denselben binären Block; \texttt{g'++} speichert ihn nur einmal. Deshalb liefern beide Programme eine asymptotisch gleich gute obere Schranke:
		\begin{align*}
